...
var sequel = `${title} 2: Back from the Dead`;
...
// Express the following in code: If the variable title (pages?) is less than 1000 log
...
// different numbers below two hundred.
 ...
 var belowTwoHundred = [ 30, 167, 2, 98, 14, 183, 55, 9, 124, 72, 6, 21 ];
